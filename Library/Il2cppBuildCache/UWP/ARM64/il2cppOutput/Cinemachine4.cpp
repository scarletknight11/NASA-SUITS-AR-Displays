...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void UpdateStatus_OnUpdate_m22DED61941774ECFB0119BAAE3BD2C164D39D521 (UpdateStatus_t6D890F291503BB7E5B1904375EC9297AA60A5E0B * __this, int32_t ___currentFrame0, int32_t ___currentClock1, Matrix4x4_tDE7FF4F2E2EA284F6EFE00D627789D0E5B8B4461  ___pos2, const RuntimeMethod* method)
{
	...
	UpdateStatus_t6D890F291503BB7E5B1904375EC9297AA60A5E0B * G_B16_0 = NULL;
	int32_t G_B18_0 = 0;
	UpdateStatus_t6D890F291503BB7E5B1904375EC9297AA60A5E0B * G_B18_1 = NULL;
	UpdateStatus_t6D890F291503BB7E5B1904375EC9297AA60A5E0B * G_B20_0 = NULL;
	UpdateStatus_t6D890F291503BB7E5B1904375EC9297AA60A5E0B * G_B19_0 = NULL;
	int32_t G_B21_0 = 0;
	UpdateStatus_t6D890F291503BB7E5B1904375EC9297AA60A5E0B * G_B21_1 = NULL;
	{
		// if (lastPos == pos)
...
IL_0016:
	...
	}
	{
		...
		int32_t L_6 = __this->get_numWindowLateUpdateMoves_2();
		__this->set_numWindowLateUpdateMoves_2(((int32_t)il2cpp_codegen_add((int32_t)L_6, (int32_t)1)));
		goto IL_004c;
	}
...
IL_002e:
	{
		...
		int32_t L_7 = __this->get_lastFrameUpdated_5();
	...
	}
	{
		...
		int32_t L_10 = __this->get_numWindowFixedUpdateMoves_3();
		__this->set_numWindowFixedUpdateMoves_3(((int32_t)il2cpp_codegen_add((int32_t)L_10, (int32_t)1)));
	}

IL_004c:
	{
		// lastPos = pos;
		Matrix4x4_tDE7FF4F2E2EA284F6EFE00D627789D0E5B8B4461  L_11 = ___pos2;
		__this->set_lastPos_6(L_11);
		// if (numWindowFixedUpdateMoves > 3 && numWindowLateUpdateMoves < numWindowFixedUpdateMoves / 3)
		int32_t L_12 = __this->get_numWindowFixedUpdateMoves_3();
	...
	{
		int32_t L_13 = __this->get_numWindowLateUpdateMoves_2();
		int32_t L_14 = __this->get_numWindowFixedUpdateMoves_3();
		G_B9_0 = ((((int32_t)L_13) < ((int32_t)((int32_t)((int32_t)L_14/(int32_t)3))))? 1 : 0);
		goto IL_006f;
	}
...
IL_007b:
	{
		// if (numWindows == 0)
		int32_t L_16 = __this->get_numWindows_4();
	...
	}
	{
		...
		int32_t L_18 = V_0;
		UpdateStatus_set_PreferredUpdate_m0D163727BB4C16214C9A22D74656ED09CEF6C929_inline(__this, L_18, /*hidden argument*/NULL);
	}

IL_0092:
	{
		// if (windowStart + kWindowSize <= currentFrame)
		int32_t L_19 = __this->get_windowStart_1();
		int32_t L_20 = ___currentFrame0;
		V_6 = (bool)((((int32_t)((((int32_t)((int32_t)il2cpp_codegen_add((int32_t)L_19, (int32_t)((int32_t)30)))) > ((int32_t)L_20))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_21 = V_6;
		if (!L_21)
		{
			goto IL_00eb;
	...
	}
	{
		// PreferredUpdate = choice;
		int32_t L_22 = V_0;
		UpdateStatus_set_PreferredUpdate_m0D163727BB4C16214C9A22D74656ED09CEF6C929_inline(__this, L_22, /*hidden argument*/NULL);
		// ++numWindows;
		int32_t L_23 = __this->get_numWindows_4();
		__this->set_numWindows_4(((int32_t)il2cpp_codegen_add((int32_t)L_23, (int32_t)1)));
		// windowStart = currentFrame;
		int32_t L_24 = ___currentFrame0;
		__this->set_windowStart_1(L_24);
		// numWindowLateUpdateMoves = (PreferredUpdate == UpdateClock.Late) ? 1 : 0;
		int32_t L_25;
		L_25 = UpdateStatus_get_PreferredUpdate_mF6224BC9B52B95B06ECD82F3CCDAC7B0994B9B6F_inline(__this, /*hidden argument*/NULL);
		G_B16_0 = __this;
...
IL_00d3:
	{
		NullCheck(G_B18_1);
		G_B18_1->set_numWindowLateUpdateMoves_2(G_B18_0);
		// numWindowFixedUpdateMoves = (PreferredUpdate == UpdateClock.Fixed) ? 1 : 0;
		int32_t L_26;
		L_26 = UpdateStatus_get_PreferredUpdate_mF6224BC9B52B95B06ECD82F3CCDAC7B0994B9B6F_inline(__this, /*hidden argument*/NULL);
		G_B19_0 = __this;
		if (!L_26)
		{
			G_B20_0 = __this;
...
IL_00e5:
	{
		NullCheck(G_B21_1);
		G_B21_1->set_numWindowFixedUpdateMoves_3(G_B21_0);
	}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Item_tD358B647F06D81E0559DB72CB866D99EF2538A6B  Item_Lerp_m729C3CBFCA75B42CC2799D491DEF4C17C53602DC (Item_tD358B647F06D81E0559DB72CB866D99EF2538A6B  ___a0, Item_tD358B647F06D81E0559DB72CB866D99EF2538A6B  ___b1, float ___t2, const RuntimeMethod* method)
{
	...
	memset((&V_0), 0, sizeof(V_0));
	Item_tD358B647F06D81E0559DB72CB866D99EF2538A6B  V_1;
...
IL_003f:
	{
		// }
		Item_tD358B647F06D81E0559DB72CB866D99EF2538A6B  L_13 = V_1;
		return L_13;
	}
}
