...
IL_0040:
	...
	}
	{
		...
		NullCheck(L_12);
		bool L_13;
		L_13 = InterfaceFuncInvoker0< bool >::Invoke(3 /* System.Boolean Windows.Storage.Streams.IRandomAccessStream::get_CanRead() */, IRandomAccessStream_tDCB9A428BBF102A296B9FECF0A68EA792444395A_il2cpp_TypeInfo_var, L_12);
		if (!L_13)
		{
			goto IL_0060;
		}
...
IL_0060:
	...
	}
	{
		...
		NullCheck(L_16);
		bool L_17;
		L_17 = InterfaceFuncInvoker0< bool >::Invoke(4 /* System.Boolean Windows.Storage.Streams.IRandomAccessStream::get_CanWrite() */, IRandomAccessStream_tDCB9A428BBF102A296B9FECF0A68EA792444395A_il2cpp_TypeInfo_var, L_16);
		if (!L_17)
		{
			goto IL_0076;
		}
...
IL_0076:
	{
		...
		NullCheck(L_19);
		bool L_20;
		L_20 = InterfaceFuncInvoker0< bool >::Invoke(3 /* System.Boolean Windows.Storage.Streams.IRandomAccessStream::get_CanRead() */, IRandomAccessStream_tDCB9A428BBF102A296B9FECF0A68EA792444395A_il2cpp_TypeInfo_var, L_19);
		if (L_20)
		{
			goto IL_0080;
		}
...
IL_0080:
	{
		...
		NullCheck(L_21);
		bool L_22;
		L_22 = InterfaceFuncInvoker0< bool >::Invoke(4 /* System.Boolean Windows.Storage.Streams.IRandomAccessStream::get_CanWrite() */, IRandomAccessStream_tDCB9A428BBF102A296B9FECF0A68EA792444395A_il2cpp_TypeInfo_var, L_21);
		if (L_22)
		{
			goto IL_008a;
		}
...
IL_0019:
	{
		NullCheck(G_B2_0);
		uint64_t L_3;
		L_3 = InterfaceFuncInvoker0< uint64_t >::Invoke(1 /* System.UInt64 Windows.Storage.Streams.IRandomAccessStream::get_Position() */, IRandomAccessStream_tDCB9A428BBF102A296B9FECF0A68EA792444395A_il2cpp_TypeInfo_var, G_B2_0);
		uint64_t L_4 = L_3;
		G_B3_0 = L_4;
		if ((!(((uint64_t)L_4) > ((uint64_t)((int64_t)(std::numeric_limits<int64_t>::max)())))))
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR int32_t WinRtToNetFxStreamAdapter_ReadByte_m319F6E7174A50839186820A8FF51BBED0B546162 (WinRtToNetFxStreamAdapter_tD80B23D09908ED4FB814064B29A5FF84D3C6404D * __this, const RuntimeMethod* method)
{
	ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* V_0 = NULL;
	{
		...
		ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726* L_1 = V_0;
		int32_t L_2;
		L_2 = VirtFuncInvoker3< int32_t, ByteU5BU5D_tDBBEB0E8362242FA7223000D978B0DD19D4B0726*, int32_t, int32_t >::Invoke(28 /* System.Int32 System.IO.Stream::Read(System.Byte[],System.Int32,System.Int32) */, __this, L_1, 0, 1);
		if (L_2)
		{
			goto IL_0014;
		}
