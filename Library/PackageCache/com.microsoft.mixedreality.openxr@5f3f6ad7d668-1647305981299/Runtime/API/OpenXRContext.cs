...
namespace Microsoft.MixedReality.OpenXR
{
    ...
    public class OpenXRContext
    {
        ...
        /// <summary>
        /// Whether the current XrSession is running, i.e. when frame loop is in progress.
        /// </summary>
        ...
        /// <summary>
        /// Get the function point to PFN_xrGetInstanceProcAddr that includes Unity OpenXR plugin and features.
